...
namespace SimplePaletteQuantizer.Quantizers.DistinctSelection
{
    ...
    public class DistinctSelectionQuantizer : BaseColorCacheQuantizer
    {
...
#if (UseDictionary)
        ConcurrentDictionary<int, DistinctColorInfo> colorMap;
#else
        DistinctBucket rootBucket;
#endif
        ...
        static bool ProcessList(int colorCount, List<DistinctColorInfo> list, ICollection<IEqualityComparer<DistinctColorInfo>> comparers, out List<DistinctColorInfo> outputList)
        {
        ...
        /// </summary>
        class ColorHueComparer : IEqualityComparer<DistinctColorInfo>
        {
        ...
        /// </summary>
        class ColorSaturationComparer : IEqualityComparer<DistinctColorInfo>
        {
            public bool Equals(DistinctColorInfo x, DistinctColorInfo y)
            {
        ...
        /// </summary>
        class ColorBrightnessComparer : IEqualityComparer<DistinctColorInfo>
        {
            public bool Equals(DistinctColorInfo x, DistinctColorInfo y)
            {
