...
namespace SimplePaletteQuantizer.Quantizers.Octree
{
    internal class OctreeNode
    {
        ...
        static readonly byte[] Mask = new byte[] { 0x80, 0x40, 0x20, 0x10, 0x08, 0x04, 0x02, 0x01 };
        ...
        static int GetColorIndexAtLevel(Color color, int level)
        {
