...
namespace SimplePaletteQuantizer.Quantizers.XiaolinWu
{
    ...
    public class WuColorQuantizer : BaseColorQuantizer
    {
        ...
        const int MaxColor = 512;
        const int Red = 2;
        const int Green = 1;
        const int Blue = 0;
        const int SideSize = 33;
        const int MaxSideIndex = 32;
        const int MaxVolume = SideSize * SideSize * SideSize;
        ...
        /// </summary>
        static long Volume(WuColorCube cube, long[,,] moment)
        {
        ...
        /// </summary>
        static float VolumeFloat(WuColorCube cube, float[,,] moment)
        {
            return moment[cube.RedMaximum, cube.GreenMaximum, cube.BlueMaximum] -
                   moment[cube.RedMaximum, cube.GreenMaximum, cube.BlueMinimum] -
                   moment[cube.RedMaximum, cube.GreenMinimum, cube.BlueMaximum] +
        ...
        /// </summary>
        static long Top(WuColorCube cube, int direction, int position, long[,,] moment)
        {
            switch (direction)
            {
                case Red:
        ...
        /// </summary>
        static long Bottom(WuColorCube cube, int direction, long[,,] moment)
        {
            switch (direction)
            {
                case Red:
        ...
        /// </summary>
        float CalculateVariance(WuColorCube cube)
        {
        ...
        /// </summary>
        float Maximize(WuColorCube cube, int direction, int first, int last, IList<int> cut, long wholeRed, long wholeGreen, long wholeBlue, long wholeWeight)
        {
        ...
        /// </summary>
        bool Cut(WuColorCube first, WuColorCube second)
        {
            int direction;
        ...
        /// </summary>
        static void Mark(WuColorCube cube, int label, IList<int> tag)
        {
