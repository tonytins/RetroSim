...
namespace SimplePaletteQuantizer.Helpers
{
    public class ColorModelHelper
    {
        ...
        const float TwoThirds = 2.0f * OneThird;
        public const double HueFactor = 1.4117647058823529411764705882353;

        static readonly float[] XYZWhite = new[] { 95.05f, 100.00f, 108.90f };

        #endregion

        #region | -> RGB |

        static int GetColorComponent(float v1, float v2, float hue)
        {
            float preresult;
        ...
        static float GetXYZValue(float value)
        {
