...
namespace SimplePaletteQuantizer.Helpers.Pixels.NonIndexed
{
    ...
    public struct PixelDataArgb64 : INonIndexedPixel
    {
        ...
        [FieldOffset(0)] ushort blue;   // 00 - 15
        [FieldOffset(2)] ushort green;  // 16 - 31
        [FieldOffset(4)] ushort red;    // 32 - 47
        [FieldOffset(6)] ushort alpha;  // 48 - 63

        // raw high-level values
        [FieldOffset(0)] ulong raw;    // 00 - 63
