...
namespace SimplePaletteQuantizer.Helpers.Pixels.NonIndexed
{
    ...
    public struct PixelDataRgb8888 : INonIndexedPixel
    {
        ...
        [FieldOffset(0)] readonly byte blue;    // 00 - 07
        [FieldOffset(1)] readonly byte green;   // 08 - 15
        [FieldOffset(2)] readonly byte red;     // 16 - 23
        [FieldOffset(3)] readonly byte unused;  // 24 - 31

        // raw high-level values
        [FieldOffset(0)] int raw;             // 00 - 23
