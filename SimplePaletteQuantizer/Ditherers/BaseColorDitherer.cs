...
namespace SimplePaletteQuantizer.Ditherers
{
    public abstract class BaseColorDitherer : IColorDitherer
    {
        ...
        /// </summary>
        protected int ColorCount { get; set; }

        /// <summary>
        /// Gets the source buffer.
        /// </summary>
        protected ImageBuffer SourceBuffer { get; set; }

        /// <summary>
        /// Gets the target buffer.
        /// </summary>
        protected ImageBuffer TargetBuffer { get; set; }

        /// <summary>
        /// Gets the quantizer.
        /// </summary>
        protected IColorQuantizer Quantizer { get; set; }

        /// <summary>
        /// Cache: Access to already created coeficient matrix.
        /// </summary>
        protected byte[,] CachedMatrix { get; set; }

        /// <summary>
        /// Cache: Access to already created coeficient matrix with division performed.
        /// </summary>
        protected float[,] CachedSummedMatrix { get; set; }
